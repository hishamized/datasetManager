...
@section('content')
<div class="container">
    <h1 class="my-4">Available Projects</h1>
    ...
    <form class="m-4" action="{{ route('projects.search.public') }}" method="POST" class="mb-4">
        @csrf
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="d-flex col-md-1">
                ...
                <a href="{{ route('showProjectsPublicly') }}" class="btn btn-danger mx-2">Reset</a>
            </div>
        </div>
    </form>
